...
const WhatsAppButton = () => {
  ...
  return (
    <motion.div
      onClick={handleClick}
      className="fixed md:hidden bottom-2 right-2 z-50 bg-green-500 text-white p-4 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300 hover:shadow-xl transform hover:scale-105 cursor-pointer group"
